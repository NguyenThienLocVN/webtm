...
$datadanhmuc = mysqli_fetch_all($query, MYSQLI_ASSOC);
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between">
              ...
              <a href="./create-category.php" class="btn btn-primary">Thêm danh mục</a>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a href='http://localhost/MiniStore-PHP/app/backend/edit-category.php?category_id=<?php echo $cat['id'] ?>' class="btn btn-primary">Sửa</a>
                        <a href='http://localhost/MiniStore-PHP/app/backend/delete-category.php?category_id=<?php echo $cat['id'] ?>' class="btn btn-secondary">Xóa</a>
                      </td>
                    </tr>
                    <?php } ?>
