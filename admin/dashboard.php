            ...
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="bg-gradient-primary border-radius-lg h-100">
                        <img src="../assets/images/shapes/waves-white.svg" class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                        <div class="position-relative d-flex align-items-center justify-content-center h-100">
                        <img class="w-100 position-relative z-index-2 pt-4" src="../assets/images/illustrations/rocket-white.png" alt="rocket">
                        </div>
                    </div>
                    </div>
                </div>
