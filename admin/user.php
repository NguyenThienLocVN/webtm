...
$sql = "SELECT * FROM users"; //Cau lenh truy van SQL
$query = mysqli_query($connect, $sql); // Thưc thi cau lenh SQL

$dataUser = mysqli_fetch_all($query, MYSQLI_ASSOC); // Tra ve du lieu dang mang
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  " href="./dashboard.phpx`">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between">
              <h6>Users | Danh sách người dùng</h6>
            </div>
                  ...
                  <tbody>
                    ...
                    <?php foreach($dataUser as $data) { ?>
                      <tr>
                        ...
                        <td class="text-center"><?php echo ($data['gender'] == 0) ? "Nữ" : "Nam" ?></td>
